...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	<head> 
		...
		<title>Hi-Fi Octopii Cart</title> 
		<style type="text/css">
		...
		<!--
			if ((navigator.userAgent.match(/iPhone/i)) || (navigator.userAgent.match(/iPod/i))) {
   			location.replace("cart_mobile.php");
		}
		-->
		</script>
		<script type="text/javascript">
	...
	<body>
				...
				<div class="grid_12">
					<div id="topNav">
						...
						<ul id="topNavListOne">
							...
							<li><a href="login.php">Hello Guest - Login/Sign Up</a></li>							<li><a href="company.php">Company</a></li>
		...
		<div id="mainContent" class="container_12">
			<div id="sideBarNav" class="grid_2">
				<h3 id="products">Products</h3>
				<ul id="productsList">
					<li><a href="catalog.php">All Products</a></li>
					<li><a href="catalog.php?newRelease=1">New Releases</a></li>
					<li><a href="catalog.php?sale=1">Sale</a></li>
				</ul>
			</div>
			<div id="cartContainer" class="grid_10">
				<h2 id="cartHeader">Cart</h2>
				<p class="cartTotalMessage">Your total cart quantity is 0</p><p class="cartTotalMessage">Your total cart cost is $0</p><p class="cartMessage">Uh Oh! Your cart is empty and your wallet is full of cash! You should balance them out by spending your money with us!</p>			</div>
		</div>
