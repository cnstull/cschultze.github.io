...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
    <head> 
        ...
        <title>Hi-Fi Octopii Thanks</title> 
        <style type="text/css">
    ...
    <body>
        ...
        <div id="mainContent" class="container_12">
        	<div class="paypalMessage">
        		<h2>A Big Thank You from Hi-Fi Octopii.</h2>
        		<p>Thank you for your order! You should be receiving your goodies soon! We look forward to your future business!</p>
        	</div>
        </div>
